...
var State = History.getState(); // Note: We are using History.getState() instead of event.state
    ...
    if(historyBool){
        ...
        var pageBoxes = {
          ...
          'add-domain' : {'title' : 'دامنه جدید را وارد نمایید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/add-domain.html', 'crumb' : 1},
          'websiteIntg' : {'title' : 'وبسایت‌تان را متصل نمایید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/website-intg.html', 'crumb' : 2},
            ...
            if (checkCookie('sbm_token')==="cookieSet") {
              ...
              $('#registerContent').load(pageBoxes[stateObject.contentId]['tmp'],function(e) {
                ...
                switch (stateObject.contentId) {
                  ...
                  $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>نوتیفیکیشن‌ها با قرار دادن کد زیر در سایت‌تان نمایش داده خواهند شد. </br>ما منتظر می‌مانیم تا کد زیر را در سایت‌تان بگذارید؛ اما اگر بخواهید هم می‌توانید از این مرحله عبور کنید.</p></div></div>');
                  ...
                  if ((checkCookie('dId')==="cookieSet") && (getCookie('dId') !== "null")) {
                    ...
                    $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>حالا باید اولین سایت‌تان را ثبت نمایید! </br> ضمنا شما می‌توانید بی‌نهایت وبسایت جدید بدون پرداخت هرگونه هزینه‌ای درج نمایید.</p></div></div>');
                      ...
                      $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>چه نوع کمپینی مد نظرتان است؟ </br>هر یک از انواع کمپین‌های زیر، بسته به نیاز شما افزایش خیره کننده فروش شما را در بر دارد.</p></div></div>');
                      ...
                      if ((checkCookie('dId')==="cookieSet") && (getCookie('dId') !== "null")) {
                        ...
                        document.getElementById('helpBoxContent').innerHTML = '<p>  ابزار ارتباط با سرویس ثابت میکنیم را انتخاب نمایید. </br> با انتخاب هر یک از ابزارهای زیر، سرویس ثابت میکنیم کمپین را با آن انجام خواهد داد.  </p>';
                        ...
                        if ((checkCookie('dId')==="cookieSet") && (getCookie('dId') !== "null")) {
                          ...
                          $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>توضیحات مرتبط با ابزار انتخابی‌تان را در کادر زیر مشاهده بفرمایید.</p></div></div>');
                          ...
                          $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>تنظیمات مرتبط با ابزار انتخاب شده در مرحله قبلی را طبق آموزش‌ها انجام دهید.</p></div></div>');
                          ...
                          if ((checkCookie('dId')==="cookieSet") && (getCookie('dId') !== "null")) {
                            ...
                            $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>اگر فرمی دارید که خارج از هر ابزاری است که لیست آن را مشاهده کردید، </br>باید آدرس صفحه حاوی فرم را در فیلد زیر وارد نمایید و فرم و فیلدها را برای ما مشخص نمایید.</p></div></div>');
                            ...
                            if ((checkCookie('dId')==="cookieSet") && (getCookie('dId') !== "null")) {
                              ...
                              $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>نوع نوتیفیکیشن‌ها و طرح آن‌ها را انتخاب نمایید. </br>همچنین تنظیمات نمایش هر یک از نوتیف‌ها را نیز می‌توانید در این قسمت انجام دهید.</p></div></div>');
                              ...
                              $('#helpBoxBody').append('<div class="helpBox"><span class="icon"> <i class="fas fa-info-circle"></i> </span><div class="content" id="helpBoxContent"><p>لینک همه صفحات سایت‌تان را که می‌خواهید نوتیفکیشن‌ها در آن نمایش داده شود را وارد نمایید.</p></div></div>');
...
function createView(stateObject, pushHistory) {
  ...
  var pageBoxes = {
    ...
    'toolConnectionSettings' : {'title' : 'تنظیمات ابزار اتصال به سرویس ثابت میکنیم', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/tool-connection-settings.html', 'crumb' : 6},
    'toolVerifyConnectionSettings' : {'title' : 'تایید و انجام تنظیمات نهایی ابزار ثابت میکنیم', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/tool-verify-connection-settings.html', 'crumb' : 6},
    'toolCustomForm' : {'title' : 'لینک صفحه حاوی فرم برای دریافت اطلاعات را وارد نمایید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/tool-capture-form.html', 'crumb' : 7},
    'toolDisplayPages' : {'title' : 'لینک صفحاتی که می‌خواهید نوتیفیکیشن‌ها را در آن‌ها نمایش دهید را وارد نمایید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/tool-display-pages.html', 'crumb' : 8},
    'toolSettings' : {'title' : 'نوع نوتیفیکیشن‌ها و تنظیمات مرتبط با آن‌ها را انجام دهید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/tool-settings.html', 'crumb' : 9},
    'campaignName' : {'title' : 'نامی برای کمپین‌تان انتخاب نمایید', 'tmp' : 'http://amins-macbook-pro.local:5757/sabetmikonimv2/template/campaign/campaign-name.html', 'crumb' : 9},
  };
    ...
    if (lastStateData.contentId === stateObject.contentId) {
      ...
      History.replaceState({contentId: stateObject.contentId, pageRepeat: pageRepeat },pageBoxes[stateObject.contentId]['title'],'http://amins-macbook-pro.local:5757/sabetmikonimv2/getstart.php/?page='+stateObject.contentId);
...
function callbackAjaxReq(getData,reqType,moreData) {
  ...
  if (reqType === "checkDomain") {
    ...
    if (getData.status === "campaignNameGot") {
      ...
      if ((getData.progressPage !== "NOT") && (getData.progressPage !== "")) {
