...
<div class="main-panel">
  ...
  <div class="campaignNewSteps">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 stepGrid">
      ...
      <div class="stepItem" id="stepItem1">
        ...
        <a href="1" name="campaignStep" onclick="campaignTabs(1)" class="more"> امکانات </a>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 stepGrid">
      ...
      <div class="stepItem" id="stepItem2">
        ...
        <a href="2" name="campaignStep" onclick="campaignTabs(2)" class="more"> فرم ها </a>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 stepGrid">
      ...
      <div class="stepItem" id="stepItem3">
        ...
        <a href="3" name="campaignStep" onclick="campaignTabs(3)" class="more">نمایش</a>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 stepGrid">
      ...
      <div class="stepItem" id="stepItem4">
        ...
        <a href="4" name="campaignStep" onclick="campaignTabs(4)" class="more"> تنظیمات </a>
  ...
  <div class="content newCampaignBody" style="position: relative; padding-bottom: 100px">
    <div class="container-fluid">
      ...
      <form action="" method="post" id="newCampaign">
        ...
        <div class="row campaignSteps campaignName" style="display:block" id="step0">
          ...
          <div class="col-md-12">
            ...
            <input type="hidden" name="cidInput" value="">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="campaignName" placeholder="یک نام وارد نمایید" autofocus>
                    </div>
                  </div>
                </div>
        ...
        <div class="row campaignSteps" style="display:none" id="step1">
          ...
          <div class="row" style="height: 390px">
            ...
            <div class="col-xs-12 col-md-4">
              ...
              <label for="raOption" class="card" id="raOptionLabel">
            ...
            <div class="col-xs-12 col-md-4">
              ...
              <label for="hsOption" class="card" id="hsOptionLabel">
            ...
            <div class="col-xs-12 col-md-4">
              ...
              <label for="lvOption" class="card" id="lvOptionLabel">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
              ...
              <label for="cbOption" class="card" id="cbOptionLabel">
        ...
        <div class="row campaignSteps captureForms campaignForms" style="display:none" id="step2">
          ...
          <div id="captureLinksBody">
            ...
            <div class="col-md-12 captureLinksBody" id="captureCardGrid1" data-count="1">

              <div class="card" style="padding-bottom: 0">



                <div class="loadingBarCard">

                  <div class="loadingBodyCard">
                  ...
                  <div class="loadingMaskCard"></div>

                </div> <!-- loading bar card -->




                <div class="header">
                  <h4 class="title"> لینک صفحه وبسایت‌تان را وارد نمایید </h4>


                  <div class="siteStatus" style="display:none" id="status1">
                ...
                <div class="content">
                  ...
                  <div id="captureCardContent">

                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group" id="siteInputFormGroup1" style="margin-bottom: 45px">
                          <label> لینک صفحه حاوی فرم </label>

                          <div class="inputs">

                            <div class="selectBody">

                              <select class="conditionsSelect" name="captureConditionsInput1">
                          ...
                          <input type="text" autocomplete="off" autofocus class="form-control captureSiteInput" onfocus="clearActions(1,1)" onkeyup="realType(this.value,1,1)" name="siteInput1" id="siteInput1" placeholder="https://blinkco.net/order-instagram-packages/">
                          ...
                          <div onclick="test(1,1,1)" class="selectLink selectLink1" style="display:none">
                        ...
                        <div class="form-group">
                          ...
                          <!-- <label>
                             ...
                             آیدی فیلد ایمیل
                               ...
                               <span class="info input" id="campaignEmailIdSelector" data-tippy> <i class="fas fa-question"></i> </span>

                               <div id="campaignEmailIdHelp" class="disn">
                                 <p> <a href="#" class="helpLink"> لینک آموزش پیدا کردن آیدی فیلد  </a> </p>
                               </div>
                          ...
                          <input type="hidden" class="form-control" name="emailField1">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <!-- <label>
                             ...
                             آیدی فیلد نام (و نام خانوادگی)

                               <span class="info input" id="campaignNameIdSelector" data-tippy> <i class="fas fa-question"></i> </span>

                               <div id="campaignNameIdHelp" class="disn">
                                 <p> <a href="#" class="helpLink"> لینک آموزش پیدا کردن آیدی فیلد  </a> </p>
                               </div>
                          ...
                          <input type="hidden" class="form-control" name="nameField1">
                        </div>
                      </div>
                    </div>
                  </div> <!-- captureCardContent -->
        ...
        <div class="row campaignSteps displayForms campaignForms" style="display:none" id="step3">
          ...
          <div id="displayLinksBody">
            ...
            <div class="col-md-12" id="displayCardGrid1">

              <div class="card">
                <div class="header">
                  <h4 class="title"> لینک 1</h4>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" id="displaySiteInputFormGroup1">
                        <label> لینک صفحه نمایش نوتیفیکشن‌ها </label>

                        <div class="inputs">

                          <div class="selectBody">

                            <select class="conditionsSelect" name="displayConditionsInput1">
                            ...
                            <input type="text" autocomplete="off" class="form-control displaySiteInput" onfocus="clearActions(1,2)" onkeyup="realType(this.value,1,2)" name="displaySiteInput1" id="displaySiteInput1" placeholder="https://blinkco.net/">

                            <div class="clear"></div>

                          </div> <!-- inputs-->

                        <div onclick="test(1,2,2)" class="selectLink displaySelectLink1" style="display:none">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" id="notifLinkStatusFormGroup1">
                        ...
                        <input type="text" autocomplete="off" class="form-control notifLink" onfocus="clearActions(1,3)" onkeyup="realType(this.value,1,3)" name="notifLink1" id="notifLink1" placeholder="https://blinkco.net/">
        ...
        <div class="formFooter">
          ...
          <a href="javascript:;" name="submitForm" onclick="campaignSteps(5,'end')" class="btn btn-fill btn-lg nextButton" style="display:none"> ثبت و اجرای کمپین </a>

          <!-- <button type="submit" name="submitForm" class="btn btn-fill btn-lg" style="display:none"> ثبت و اجرای کمپین </button> -->
        ...
        <div class="modalOption" id="raModal" ng-app="" ng-init="campaignMessage='از پکیج‌های اینستاگرام ما استفاده کرده است.'">
                        ...
                        <div class="notifContentBody">
                          ...
                          <div class="clear"></div>
                           <div class="notifDescContents">
                             <div class="notifDesc" id="notifDesc"> {{campaignMessage}} </div>
          ...
          <div class="section">
            ...
            <div class="container">
              ...
              <input type="text" name="raMessage" ng-model="campaignMessage">
          ...
          <div class="section" style="padding-bottom: 0">
            ...
            <div class="optionsBody">
              ...
              <div class="inlineOption flex-inline">
                ...
                <div class="flex-inline-col"> <input type="text" name="lastConversions" value="20"> </div>
              ...
              <div class="inlineOption flex-inline">
                ...
                <div class="flex-inline-col"> نمایش نوتیفیکشن‌های</div>
                <div class="flex-inline-col"> <input type="text" name="lastConversionsByDay" value="2"> </div>
              ...
              <div class="inlineOption flex-inline">
                ...
                <div class="flex-inline-col"> <input type="text" name="minConversions" value="1"> </div>
                <div class="flex-inline-col"> نوتیفیکیشن ثبت شده باشد. </div>
              ...
              <div class="inlineOption flex-inline">
                ...
                <div class="col-md-4 noPaddingLeft">
                  ...
                  <div class="checkBodySwitch">
                    ...
                    <input type="checkbox" class="switchdemo" name="anonymousNotif" value="false">
              ...
              <div class="inlineOption">
                ...
                <div class="col-md-4 noPaddingLeft">
                  ...
                  <div class="checkBodySwitch">
                    ...
                    <input type="checkbox" class="switchdemo" name="raCampaignLoop" checked value="false">
      ...
      <!-- deactive feature modal -->

      <div class="modalOption" id="deactiveFeatures">

        <div class="title">

          <h4> امکانات غیر فعال </h4>

        </div> <!--title -->

        <div class="modalRow intgContent" style="margin: auto;">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <p>
                          ...
                          در پنل « ثابت میکنیم » کلیه امکانات بر اساس پکیجی که خریداری نموده‌اید، برای شما فعال یا غیر فعال خواهد بود.

                          اگر می‌خواهید کارکرد هر یک از امکانات پنل را بدانید روی عناوین زیر کلیک نمایید:
          ...
          <div class="modalButtons">
            ...
            <a href="#" name="closeModal" class="btn btn-fill"> تکمیل این قدم </a>
